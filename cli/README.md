...
Repeatable `--values` files provide platform image, runtime, and hardware settings. Use `--oci-registry` for mirrored release images and CLI-managed charts; configure Hugging Face mirrors under `runtime.vllm.modelSource`.
