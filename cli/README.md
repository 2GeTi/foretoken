...
The command does not generate traffic. See [Profiling](../observability/profiling.md) for prerequisites, result access and capture around a benchmark workload.
